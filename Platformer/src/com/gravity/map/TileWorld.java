...
public class TileWorld implements GameWorld {
    ...
    public void render(Graphics g, int offsetX, int offsetY) {
        /*
         * // if we need to draw hitboxes again: g.pushTransform(); g.translate(offsetX, offsetY); g.setColor(Color.red); for (Collidable e :
         * entityNoCalls) { g.draw(e.getRect(0).toShape()); } g.setColor(Color.white); g.resetTransform(); g.popTransform();
         */
